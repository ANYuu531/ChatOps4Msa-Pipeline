...
cd ..
git clone git@github.com:ANYuu531/ChatOps4Msa-Sample-Bookinfo-Productpage.git
git clone git@github.com:ANYuu531/ChatOps4Msa-Sample-Bookinfo-Reviews.git
git clone git@github.com:ANYuu531/ChatOps4Msa-Sample-Bookinfo-Ratings.git
git clone git@github.com:ANYuu531/ChatOps4Msa-Sample-Bookinfo-Details.git
cd ChatOps4Msa
