...
- payment -> cart  (sync-http, documented)  code: payment/payment.py:116
- payment -> paypal.com  (external, documented)  code: payment/payment.py:26
- payment -> rabbitmq  (async, documented)  code: docker-compose.yaml
- payment -> user  (sync-http, documented)  code: payment/payment.py:64
...
- web -> cart  (sync-http, inferred)  code: web/default.conf.template:69
- web -> catalogue  (sync-http, documented)  code: docker-compose.yaml
- web -> payment  (sync-http, documented)  code: docker-compose.yaml
- web -> ratings  (sync-http, inferred)  code: web/default.conf.template:81
...
- shipping  =>  http://%s/shipping/   @ shipping/src/main/java/com/instana/robotshop/shipping/Controller.java:24
